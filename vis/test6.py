...
for group_name, group_data in grouped:
    ...
    hover_text = [f"File: {permiFileNames[i]} #subjects: {permiTrainingLength[i]} <br> training subjects: {permiTrainingSubjects[i][0]} <br> testing subjects: {permiTestingSubjects[i][0]}" for i in range(len(permiFileNames))]
    plot = html.Div(
