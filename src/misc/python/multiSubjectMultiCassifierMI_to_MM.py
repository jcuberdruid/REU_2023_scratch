...
subjects = generate_random_numbers(15)
...
test_data_1 = create_data(csv_label_1_MM, subjects, npy_label_1_MM)
test_data_2 = create_data(csv_label_2_MM, subjects, npy_label_2_MM)
